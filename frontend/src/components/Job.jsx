  ...
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border border-gray-50'>
      ...
      <div>
        ...
        <Badge className={'text-blue-700 font-bold'} variant='ghost'>{job?.jobType} Position</Badge>
        <Badge className={'text-blue-700 font-bold'} variant='ghost'>{job?.salary} LPA</Badge>
      </div>
      <div>
        <Button variant='outline' onClick={()=> navigate(`/descriptions/${job?._id}`)} >Details</Button>
